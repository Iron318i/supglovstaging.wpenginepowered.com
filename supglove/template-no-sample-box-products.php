<?php
/**
 * Template Name: No Sample Box Products
 *
 * The template file for displaying the "No Sample Box Products" page.
 *
 * @package Supglove
 */
...
?>
	...
	<aside id="primary-sidebar" class="widgets-area primary-sidebar <?php if (isset($sidebar)) { echo esc_attr( $sidebar ); } ?> attribute-page col-xs-12 col-sm-12 col-md-3">
        ...
        if (is_active_sidebar('no-sample-box-category')) {
            dynamic_sidebar('no-sample-box-category');
        }
