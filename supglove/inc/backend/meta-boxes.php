...
function supro_register_meta_boxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		'id'       => 'header-settings',
		'title'    => esc_html__( 'Header Menu Settings', 'supro' ),
		'pages'    => array( 'page' ),
		'context'  => 'normal',
		'priority' => 'high',
		'fields'   => array(
...
//FOR BLOG SINGLE PAGE
	$meta_boxes[] = array(
		'id'       => 'page-header-settings_blog',
		'title'    => esc_html__( 'Post Header Settings', 'supro' ),
		'pages'    => array('post' ),
		'context'  => 'normal',
		'priority' => 'high',
		'fields'   => array(			
			array(
				...
				'id'    => 'heading_background_blog',
				'type'  => 'heading',
				'class' => 'page-header-background-heading',
			),
			array(
				'name'             => esc_html__( 'Background Image', 'supro' ),
				'id'               => 'page_header_bg_blog',
				'type'             => 'image_advanced',
				'max_file_uploads' => 1,
				'std'              => false,
			...
			array(
				...
				'id'      => 'page_header_background_position_blog',
				'type'    => 'select',
				'std'     => '',
				'options' => array(
			...
			array(
				'name'    => esc_html__( 'Background Repeat', 'supro' ),
				'id'      => 'page_header_background_repeat_blog',
				'type'    => 'select',
				'std'     => '',
				'options' => array(
					''          => esc_html__( 'Default', 'supro' ),
			...
			array(
				'name'    => esc_html__( 'Background Size', 'supro' ),
				'id'      => 'page_header_background_size_blog',
				'type'    => 'select',
				'std'     => '',
				'options' => array(
					''        => esc_html__( 'Default', 'supro' ),
			...
			array(
				'name'    => esc_html__( 'Background Attachment', 'supro' ),
				'id'      => 'page_header_background_attachment_blog',
				'type'    => 'select',
				'std'     => '',
				'options' => array(
					''       => esc_html__( 'Default', 'supro' ),
	...
	$meta_boxes[] = array(
		'id'       => 'post-link-cta',
		'title'    => esc_html__( 'Post "LINK" format options', 'supro' ),
		'pages'    => array( 'post' ),
		'context'  => 'normal',
		'priority' => 'high',
		'fields'   => array(
			array(
				'name' => esc_html__( 'Button CTA Text', 'supro' ),
				'id'   => 'post_link_cta_text',
				'type' => 'text',
			),
			array(
				'name' => esc_html__( 'Button CTA URL', 'supro' ),
				'id'   => 'post_link_cta_url',
				'type' => 'text',
			),
		),
	);
