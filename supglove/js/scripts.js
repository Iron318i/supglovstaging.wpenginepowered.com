;(function ($) {
  ...
  supro.instanceSearch = function () {
    ...
    function search() {
      ...
      if (keyword.length < 2) {
        $modal
          .removeClass(
            'searching searched actived found-products found-no-product'
          )
      ...
      if (keycat in searchCache) {
        ...
        $(document.body).trigger('supro_ajax_search_request_success', [
          $results,
        ])
    ...
    function outSearch() {
      if (
        supro.$body.hasClass('header-layout-3') ||
        supro.$body.hasClass('header-layout-5') ||
        supro.$body.hasClass('header-layout-6')
      ) {
        return
      }
      ...
      responsive: [
        {
          ...
          settings: {
            slidesToShow:
              parseInt(relatedProductColumns) > 3
                ? 3
                : parseInt(relatedProductColumns),
            slidesToScroll: 1,
          },
        },
        {
          ...
          settings: {
            slidesToShow:
              parseInt(relatedProductColumns) > 2
                ? 2
                : parseInt(relatedProductColumns),
            slidesToScroll: 1,
          },
  ...
  supro.portfolioLoadingAjax = function () {
    ...
    $('.supro-portfolio-page')
      .find('.numeric-navigation')
      .on('click', '.page-numbers.next', function (e) {
        e.preventDefault()
