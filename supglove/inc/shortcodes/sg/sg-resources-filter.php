    ...
    <div class="sg-resources-filter__inner">
        <form method="post" <?php echo 'id="' . esc_attr($args['filter_id']) . '"'; ?> class="sg-filter-form" action="">
            <div class="sg-filter-form__all-fields-dropdown">
                <div class="sg-filter-form__filters-switcher"><span class="sg-filter-form__filters-toggle"><?php
                ...
                <div class="sg-filter-form__filters">
                    <div class="sg-filter-form__filters-inner">
                        <?php if (empty($args['filter_hide_search'])) : ?>
                            <fieldset class="sg-filter-form__fieldset sg-filter-form__fieldset--search">
                                <div class="sg-filter-form__input-wrapper sg-filter-form__input-wrapper--search">
                                    <input type="search" name="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_search" class="sg-filter-form__search" value="<?php echo esc_attr($args['filter_search']); ?>" placeholder="<?php echo esc_attr(esc_html_x('Search Resources', '[sg_resources_filter]', 'SuperiorGlove')); ?>"/>
                                    <label class="sg-filter-form__label sg-filter-form__label--search" for="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_search">
                            ...
                            <fieldset class="sg-filter-form__fieldset sg-filter-form__fieldset--dropdown sg-filter-form__fieldset--topic">
                                <details class="sg-filter-form__dropdown sg-filter-form__dropdown--topic">
                                    <summary class="sg-filter-form__dropdown-heading sg-filter-form__dropdown-heading--topic">
                                        <legend class="sg-filter-form__legend sg-filter-form__legend--dropdown sg-filter-form__legend--topic"><span class="sg-filter-form__legend-text sg-filter-form__legend-text--dropdown sg-filter-form__legend-text--topic"><?php
                                    ...
                                    <div class="sg-filter-form__dropdown-content sg-filter-form__dropdown-content--topic">
                                        <div class="sg-filter-form__input-wrapper sg-filter-form__input-wrapper--radio sg-filter-form__input-wrapper--dropdown topics-wrapper" data-parent-id="0" data-level="0">
                                            <input type="radio" name="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_topic" value="" id="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_topic_default" class="sg-filter-form__radio sg-filter-form__radio--dropdown sg-filter-form__radio--topic sg-filter-form__radio--level-0"/>
                                            <label class="sg-filter-form__label sg-filter-form__label--radio sg-filter-form__label--topic sg-filter-form__label--dropdown sg-filter-form__label--radio-level-0" for="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_topic" data-text="<?php _ex('Topics', '[sg_resources_filter]', 'SuperiorGlove'); ?>"><?php
                        ...
                        <?php endif; ?>
                        <?php
                        if (!empty($args['filter_languages']) && empty($args['filter_hide_languages'])) :
                            ...
                            <fieldset class="sg-filter-form__fieldset sg-filter-form__fieldset--dropdown sg-filter-form__fieldset--language">
                                <details class="sg-filter-form__dropdown sg-filter-form__dropdown--language">
                                    <summary class="sg-filter-form__dropdown-heading sg-filter-form__dropdown-heading--language">
                                        <legend class="sg-filter-form__legend sg-filter-form__legend--dropdown sg-filter-form__legend--language"><span class="sg-filter-form__legend-text sg-filter-form__legend-text--dropdown sg-filter-form__legend-text--language"><?php
                                                echo esc_html($default_language_name);
                                                ?></span></legend>
                                    </summary>
                                    <div class="sg-filter-form__dropdown-content sg-filter-form__dropdown-content--language">
                                        <?php if (empty($default_language_term) || empty($default_language_term->term_id)) : ?>
                                            <div class="sg-filter-form__input-wrapper sg-filter-form__input-wrapper--radio sg-filter-form__input-wrapper--dropdown languages-wrapper" data-parent-id="0" data-level="0">
                                                <?php
                                                $input_id = esc_attr($args['filter_id']) . '_sg_filter_language_default';
                                                ?>
                                                <input type="radio" name="<?php echo esc_attr($args['filter_id']); ?>_sg_filter_language" value="" id="<?php echo $input_id; ?>" class="sg-filter-form__radio sg-filter-form__radio--dropdown sg-filter-form__radio--language sg-filter-form__radio--level-0" data-language_code="<?php echo esc_attr($default_language_code); ?>"
                                                    <?php if (empty($args['filter_active_language']) || ($args['filter_active_language'] == 'all')) echo 'checked'; ?>
                                                />
                                                <label class="sg-filter-form__label sg-filter-form__label--radio sg-filter-form__label--language sg-filter-form__label--dropdown sg-filter-form__label--radio-level-0" for="<?php echo $input_id; ?>" data-text="<?php _ex('Languages', '[sg_resources_filter]', 'SuperiorGlove'); ?>">
                                                    <?php _ex('All Languages', '[sg_resources_filter]', 'SuperiorGlove'); ?>
                                                </label>
                                            </div>
                                        <?php endif; ?>
                                        <?php print_terms(
                        ...
                        <?php if (!empty($args['filter_types']) && empty($args['filter_hide_types'])) : ?>
                            <fieldset class="sg-filter-form__fieldset sg-filter-form__fieldset--nav sg-filter-form__fieldset--type">
                                <legend class="sg-filter-form__legend sg-filter-form__legend--nav sg-filter-form__legend--type"><span class="sg-filter-form__legend-text sg-filter-form__legend-text--nav sg-filter-form__legend-text--type"><?php
                        ...
                        <div class="sg-filter-form__filters-submit">
                            <button type="submit" class="sg-filter-form__button sg-filter-form__button--submit"><span class="sg-filter-form__button-text sg-filter-form__button-text--submit"><?php
                                    _ex('Apply Filters', '[sg_resources_filter]', 'SuperiorGlove');
                                    ?></span></button>
                            <button type="reset" class="sg-filter-form__button sg-filter-form__button--reset"><span class="sg-filter-form__button-text sg-filter-form__button-text--reset"><?php
