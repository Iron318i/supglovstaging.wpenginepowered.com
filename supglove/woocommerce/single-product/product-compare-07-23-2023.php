...
function groupstart($header)
{
  $result = '
    <div class="comparerow">
      ...
      <div class="col col-xs-5ths col-md-5ths col-md-5ths"></div>
      <div class="col col-xs-5ths col-md-5ths col-md-5ths"></div>
      <div class="col col-xs-5ths col-md-5ths col-md-5ths last"></div>
      <div class="clear"></div>
    </div>
  ';
  echo $result;
    ...
    <div class="containerx">
      ...
      <div class="col col-sm-12 col-md-12">
            ...
            <div class="container comparebodycont">
              <div class="coparetable">
                <?php
                  ...
                  echo htmlrowforcompare(__( 'Oil Resistant', 'woocommerce' ), array_column($comparerecords, 'pf_oil-water-repellant-treatment'));
        ...
        <div class="container comparebodycontbut">
          <div class="expand-button"><h5><?php _e( 'Show all Features', 'supro' ); ?></h5><i class="icon icon-uni3F"></i></div>
        </div>
      </div>
