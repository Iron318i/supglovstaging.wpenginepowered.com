...
foreach ( $products_to_compare as $thecompareproduct ) {
  ...
  $newcompare_record = array(
    ...
    'chemical_and_disposable_gloves_length' => $thecompareproduct->get_attribute( 'pa_chem_dispos_gloves_length' ),
    ...
    'ce_en388_certification_code' => get_post_meta( $thecompareproduct->get_id(), 'pa_ce_en388_certification_code', true  ),
    'other_ce_certification_codes' => $thecompareproduct->get_attribute( 'pa_ce_en388_certification_code' ),
  ...
  <div class="row zeromag">
    <div class="containerx">
      ...
      <div class="col col-sm-12 col-md-12">
        <h3 class="comptitle"><span><?php _e( 'Compare with similar items', 'woocommerce' ); ?></span></h3>
            ...
            <div class="container comparebodycont">
              <div class="coparetable">
                <?php
                  ...
                  echo htmlrowforcompare(__( 'Chemical Glove Length', 'woocommerce' ), array_column($comparerecords, 'chemical_and_disposable_gloves_length'));
				  ...
				  echo htmlrowforcompare(__( 'UKCA / CE Certified', 'woocommerce' ), array_column($comparerecords, 'other_ce_certification_codes'));
                 // echo htmlrowforcompare(__( 'UKCA Code', 'woocommerce' ), array_column($comparerecords, 'ukca_code'));
