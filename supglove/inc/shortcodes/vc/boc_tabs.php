...
vc_map( array(
	...
	"params" => array(
		array(
			"type" => "dropdown",
			"heading" => __("Type", 'SuperiorGlove'),
			"param_name" => "type",
			"value" => array('horizontal','vertical'),
			"std"	=> "horizontal",
			"description" => __("Pick Tab Style", 'SuperiorGlove'),
		),
		array(
			"type"		=> 'checkbox',
			"heading"	=> __("Use minimal Style?", "SuperiorGlove"),
...
vc_map( array(
	"name" => __("Tab Item", 'SuperiorGlove'),
	"base" => "boc_tab",
	"icon" 		=> "boc_tabs",
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "title",
			"value" => __("Tab Title", 'SuperiorGlove'),
			"description" => __("Set your Tab Title", 'SuperiorGlove'),
		),
	)
));
